...
$title = $myFriends ? xg_text('MY_FRIENDS') : xg_text('XS_FRIENDS', Video_FullNameHelper::fullName($this->screenName)); ?>
        ...
        <div class="xg_3col first-child">
            ...
            if (count($this->users) == 0 && !isset($this->searchFor) && $myFriends) { ?>
                <div class="xg_module">
                    ...
                    <div class="xg_module_body">
                        <?php
                        if (Video_PrivacyHelper::canCurrentUserSeeInviteLinks()) { ?>
            ...
            <?php
                ...
                $this->renderPartial('fragment_list', 'user', array(
                        'searchLabel' => xg_text('SEARCH_FRIENDS'), 'screenName' => $this->screenName, 'showViewAllPeopleLink' => true,
                        'paginationUrl' => Video_HtmlHelper::addParamToUrl($this->pageUrl, 'sort', $this->sort['code']),

...
class Forum_BulkHelper10Test extends BulkHelperTestCase {
    ...
    public function testSetPrivacy() {
        $initialIsPrivate = XG_App::appIsPrivate();
        ...
        // Change to other privacy and check it went ok.
        Forum_BulkHelper::setPrivacy(30, ! $initialIsPrivate);
        XG_Cache::invalidate(XG_Cache::INVALIDATE_ALL);
        $this->checkPrivacy(! $initialIsPrivate, $allIds);

        // Change back and check it went ok.
        Forum_BulkHelper::setPrivacy(30, $initialIsPrivate);
        XG_Cache::invalidate(XG_Cache::INVALIDATE_ALL);
        $this->checkPrivacy($initialIsPrivate, $allIds);
    }
